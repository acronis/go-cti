...
func TestAnnotationsCollector_Collect_SingleAnnotation(t *testing.T) {
	...
	schema := map[string]any{
		...
		"properties": map[string]any{
			"foo": map[string]any{
				"type": "string",
				jsonschema.XCustomKey: map[string]any{
					jsonschema.XAnnotationKey + metadata.Final: true,
				},
			},
		},
	}
	...
	schema := map[string]any{
		...
		"properties": map[string]any{
			"bar": map[string]any{
				"type": "integer",
				jsonschema.XCustomKey: map[string]any{
					jsonschema.XAnnotationKey + metadata.Final:       false,
					jsonschema.XAnnotationKey + metadata.Resilient:   true,
					jsonschema.XAnnotationKey + metadata.DisplayName: true,
				},
			},
		},
	}
	...
	schema := map[string]any{
		"anyOf": []any{
			...
			map[string]any{
				"type": "integer",
				jsonschema.XCustomKey: map[string]any{
					jsonschema.XAnnotationKey + metadata.Resilient: false,
				},
			},
		},
	}
	...
	schema := map[string]any{
		...
		"properties": map[string]any{
			"baz": map[string]any{
				"type": "string",
				jsonschema.XCustomKey: map[string]any{
					jsonschema.XAnnotationKey + metadata.PropertyNames: propertyNames,
				},
			},
		},
	}
